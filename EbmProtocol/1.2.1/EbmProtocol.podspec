...
Pod::Spec.new do |s|
    ...
    s.default_subspec = 'ProtocolServices'

    s.subspec 'ProtocolServices' do |ss|
        ss.source_files = 'EbmProtocol/Classes/**/*'
        ss.frameworks = 'Foundation', 'CoreBluetooth'
        ss.dependency 'EbmStringExtensions', '~> 0.1.1'
    ...
    s.subspec 'Protocol' do |ss|
        ss.source_files = 'EbmProtocol/Classes/**/*'
        ss.exclude_files = 'EbmProtocol/Classes/EBIKEService.swift', 'EbmProtocol/Classes/EBIKEValues.swift', 'EbmProtocol/Classes/ServiceDescriptors.swift', 'EbmProtocol/Classes/Variable+Extensions.swift'
        ss.dependency 'EbmStringExtensions', '~> 0.1.1'
    end
